...
<div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 text-white border-bottom shadow-sm"
    ...
    <nav>
        <a class="home" href="/upload"> <img src="/images/add.png" width="60"></a>

        <a class="home" href="/user"> <img src="/images/search.png" width="60"></a>

        <a class="home" href="/data"> <img src="/images/data.png" width="60"></a>
        <a class="home" href="/"> <img src="/images/logout.png" width="60"></a>
    </nav>
</div>
